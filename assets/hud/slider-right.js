...
(function() {
    ...
    app.carousel = {
        ...
        reorder: function() {
            let childcnt = $("#carousel-right").children.length;
            let childs = $("#carousel-right").children;
        ...
        move: function(el) {
            ...
            for (let i=0; i<shift; i++) {
                let el = (dir == -1) ? $("#carousel-right").firstElementChild : $("#carousel-right").lastElementChild;

                if (dir == -1) {
                    el.dataset.pos = $("#carousel-right").children.length;
                    $('#carousel').append(el);
                } else {
                    el.dataset.pos = 0;
                    $('#carousel').prepend(el);
        ...
        init: function() {
            ...
            $("#carousel-right").addEventListener("mousedown", app.carousel.doDown);
            $("#carousel-right").addEventListener("touchstart", app.carousel.doDown);
            $("#carousel-right").addEventListener("mouseup", app.carousel.doUp);
            $("#carousel-right").addEventListener("touchend", app.carousel.doUp);
