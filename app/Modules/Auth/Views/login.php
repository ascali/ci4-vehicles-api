...
<head>
	<meta charset="utf-8" />
	<title><?= getenv('prop.appname') ?> | Login Authentication</title>
						...
						<div class="d-flex flex-column h-100 text-center">
							<div class="mb-4 mb-md-5 text-center">
								<a href="/" class="d-block auth-logo">
									<img src="<?= base_url() ?><?= getenv('prop.applogo') ?>" alt="thishub" style="width: 100%; max-height: 5.5rem;"><span class="logo-txt"><?= getenv('prop.appname') ?></span>
								</a>
							...
							<div class="auth-content my-auto">
								<div class="text-center">
									...
									<p class="text-muted mt-2">Digunakan untuk user yang terdaftar</p>
								</div>
								<form id="form-login" class="custom-form mt-4 pt-2" method="POST" enctype="multipart/form-data" action="<?= base_url() ?>/main" autocomplete="one-time-code">
									...
									<div class="mb-3">
										...
										<!-- <div class="input-group auth-pass-inputgroup">
											<input type="password" class="form-control rounded-pill" id="password" name="password" placeholder="Enter password" aria-label="Password" aria-describedby="password-addon" autocomplete="one-time-code">
											<button class="btn btn-light ms-0 rounded-pill" type="button" id="password-addon"><i class="mdi mdi-eye-outline"></i></button>
										</div> -->
									</div>
									<div class="mb-3">
								...
								<div class="d-flex flex-column position-relative text-center ">
									<div class="mb-3 align-self-center justify-content-center ">
										<h5 class="mb-0">Halaman Login Dokter</h5>
									</div>
									<div class="row">
										<div class="col-lg-12">
							...
							<div class="mt-4 mt-md-5 text-center" style="color: #2A6834">
								<!-- <p class="mb-0">
									<?= getenv('prop.appshortdesc') ?><br />Operated with <i class="mdi mdi-heart text-danger"></i> by <?= getenv('prop.appauthor') ?>
								</p> -->
								<div class="text-nowrap" style="color: #2A6834">Operated by <br> <img src="<?= getenv('prop.applogooperated') ?>" alt="<?= getenv('prop.appauthor') ?> " style="width: 10rem; max-height: 100%;" /></div>
								<i class="mdi mdi-heart text-danger"></i><br>
								<span>© 2021 <?= getenv('prop.appauthor') ?></span>
							</div>
						</div>
					</div>
				</div>
												...
												<div class="mt-4 pt-3 pb-5">
													<div class="d-flex align-items-center">
														<div class="flex-shrink-0">
															<img src="<?= base_url() ?><?= getenv('prop.applogo') ?>" class="avatar-md img-fluid" style="width: 100%; max-height: 5.5rem !important;" alt="...">
														</div>
