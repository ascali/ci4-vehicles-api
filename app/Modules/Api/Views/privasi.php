                ...
                <div data-glue-responsive-accordion-static data-glue-responsive-accordion-static-breakpoints="['x-small']" class="sc-principles">
                  ...
                  <li class="glue-a-zippy--v-smooth-expand sc-principles__panel" id="principle-1" data-glue-zippy-expand>
                      <h2 class="h-c-headline h-c-headline--four sc-principles__principle-header">
                        <span role="text">1. Ketentuan Pengembalian Dana Pembayaran<span class="-no-break"> QRIS Pemohon</span>
                        </span>
                        <svg role="img" class="h-c-icon h-c-icon--chevron
                                         h-c-icon--chevron-down
                                         sc-principles__chevron">
                          <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#mi-chevron">
                          </use>
                        </svg>
                      </h2>
                      <div class="sc-principles__content">
                        <div class="sc-principles__principle-copy">
                          <p align="justify">
                            <span role="text">Proses pengembalian Dana hanya jika pemohon melakukan pembayaran Double / 2 Kali transaksi yang sebetulnya bisa dalam satu transaksi contoh Pengajuan (SIM A & C), proses pengembalian Dana Akan diproses kurang lebih maksimal 2 Hari Kerja<span class="-no-break">dan proses pengembalian Dana akan dikenakan potongan sebesar 10% dan berlaku mulai bulan September 2023.</span>
                            </span>
                          </p>
                        </div>
                      </div>
                    ...
                    <li class="glue-a-zippy--v-smooth-expand sc-principles__panel" id="principle-5" >
                      <h2 class="h-c-headline h-c-headline--four sc-principles__principle-header">
                        <span role="text">2. Kami menghormati pengguna dan <span class="-no-break">privasinya. </span>
                        </span>
                        <svg role="img" class="h-c-icon h-c-icon--chevron
                                         h-c-icon--chevron-down
                                         sc-principles__chevron">
                    ...
                    <li class="glue-a-zippy--v-smooth-expand sc-principles__panel" id="principle-2">
                      <h2 class="h-c-headline h-c-headline--four sc-principles__principle-header">
                        <span role="text">3. Kami menjelaskan data apa yang kami kumpulkan <span class="-no-break">beserta alasannya.</span>
                        </span>
                        <svg role="img" class="h-c-icon h-c-icon--chevron
                                         h-c-icon--chevron-down
                                         sc-principles__chevron">
                    ...
                    <li class="glue-a-zippy--v-smooth-expand sc-principles__panel" id="principle-3">
                      <h2 class="h-c-headline h-c-headline--four sc-principles__principle-header">
                        <span role="text">4. Kami tidak pernah menjual informasi pribadi pengguna kami kepada <span class="-no-break">siapa pun.</span>
                        </span>
                        <svg role="img" class="h-c-icon h-c-icon--chevron
                                         h-c-icon--chevron-down
                                         sc-principles__chevron">
                    ...
                    <li class="glue-a-zippy--v-smooth-expand sc-principles__panel" id="principle-4">
                      <h2 class="h-c-headline h-c-headline--four sc-principles__principle-header">
                        <span role="text">5. Kami memudahkan pengguna untuk mengontrol <span class="-no-break">privasi mereka.</span>
                        </span>
                        <svg role="img" class="h-c-icon h-c-icon--chevron
                                         h-c-icon--chevron-down
                                         sc-principles__chevron">
                      ...
                      <div class="sc-principles__content">
                        <div class="sc-principles__principle-copy">
                          <p align="justify">
                            <span role="text">Kami tahu tidak ada satu solusi yang cocok bagi semua pengguna dalam hal privasi. Setiap Akun pada Aplikasi SIMPEL POL dibuat dengan kontrol data aktif/nonaktif, sehingga pengguna kami dapat memilih setelan privasi yang tepat bagi mereka. Dan seiring berkembangnya teknologi, kontrol privasi kami juga berkembang, yang memastikan bahwa privasi selalu dikontrol <span class="-no-break">oleh pengguna.</span>
                            </span>
                          </p>
                        </div>
                      </div>
                    ...
                    <li class="glue-a-zippy--v-smooth-expand sc-principles__panel" id="principle-6">
                      <h2 class="h-c-headline h-c-headline--four sc-principles__principle-header">
                        <span role="text">6. Kami membuat teknologi keamanan terkuat ke dalam <span class="-no-break">Aplikasi kami.</span>
                        </span>
                        <svg role="img" class="h-c-icon h-c-icon--chevron
                                         h-c-icon--chevron-down
                                         sc-principles__chevron">
