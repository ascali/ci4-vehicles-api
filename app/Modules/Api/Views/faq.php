        ...
        <main id="jump-content" class="sc-main">
            <section class="sc-intro">
                <div class="h-c-page">
                    ...
                    <div class="sc-intro__copy"> <span role="text">
                            <p align="justify">Ada pertanyaan tentang Aplikasi <?= getenv('prop.appname') ?>? Kami merangkum pertanyaan seputar aplikasi <?= getenv('prop.appname') ?> dengan kategori pertanyaan dibawah ini.<span class="-no-break"> Silahkan cari informasi apa yang anda inginkan, Jika masih mengalami kesulitan silahkan hubungi kami melalui email di <b style="color: blue;">adm.<?= getenv('prop.appname') ?>@gmail.com<b>.</span>
                            </p>
                        </span>
                    </div>
                </div>
                        ...
                        <div class="h-c-grid__col h-c-grid__col--12 h-c-grid__col-l--8 h-c-grid__col-l--offset-2">
                            <div data-glue-responsive-accordion-static data-glue-responsive-accordion-static-breakpoints="['x-small']" class="sc-principles">
                                <ol class="sc-principles__list">
                                    ...
                                    $rs = $db->query("SELECT * FROM prodone_faq_cat");
                                    ?>
                                    <?php
                                    $rs = $db->query("SELECT * FROM prodone_faq_cat");
                                    $n = 0;

                                    foreach ($rs->getResult() as $items) {
                                        $n++;
                                    ?>
                                            ...
                                            <div class="sc-principles__content">
                                                <div class="sc-principles__principle-copy">
                                                    <ul>
                                                        <?php
                                                        $db = \Config\Database::connect();
                                                        $rs2 = $db->query("SELECT * from prodone_faq_content where kat_faq='" . $items->id . "'");



                                                        foreach ($rs2->getResult() as $items2) { ?>
