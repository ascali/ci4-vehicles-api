...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?= base_url() ?>/<?= getenv('prop.applogo') ?>">
    <title>Share Bus Position</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.3/dist/leaflet.css" />
    <link rel="stylesheet" href="<?= base_url('assets/css/leaflet-rm.css') ?>">
    ...
    <style>
        ...
        .border-t.border.border-gray-400.mt-2.mb-2 {
            border-color: #224dddad;
        }
...
<!-- <body class="relative"> -->
    ...
    <div class="mobile-scr">
        <div class="relative">
            <div class="absolute top-2 left-2 widget" style="min-width: 96%;">
                <div class="text-left mb-2 bg-white shadow-lg rounded-lg p-2" style="background: #ffffffcf;border: 1px solid #224ddda3; margin-right: -1%;">
                    <center>
                        <img src="<?= base_url() ?>/<?= getenv('prop.applogo') ?>" style="width: 100%;height: 13px;">
                        <p><strong>Lacak Kendaraan</strong></p>
                    </center>
                </div>
                <div class="text-left mb-2 bg-white shadow-lg rounded-lg p-2 fixed bottom-0 overflow-y-auto" style="min-width: 96%;height: 35%; background: #ffffffcf;border: 1px solid #224ddda3;">
                    <div class="flex items-center space-x-4">
                        <!-- Profile Image -->
                        <!-- <img class="w-10 h-10 rounded-full" src="<?= base_url('assets/img/icon_bus.jpeg') ?>"> -->
                    
                        <!-- Information Section -->
                        <div>
                            <p class="font-bold text-gray-800" id="nomor_kendaraan_m">B 1234 C</p>
                            <p class="font-bold text-gray-800" id="po_name_m">PO. SIANG MALAM</p>
                        </div>
                    </div>
                    <div class="border-t border border-gray-400 mt-2 mb-2"></div>
                    <div class="flex flex-col space-y-2">
                        ...
                        <div class="flex items-center justify-left">
                            <div class="h-6 border-l-2 border border-gray-400 ml-4"></div>
                        </div>
                    ...
                    <p class="text-xs text-gray-400 font-semibold mt-2">TERAKHIR UPDATE</p>
    ...
    <div class="desktop-scr">
        <div class="absolute top-2 right-2 widget">
            <div class="text-left mb-2 bg-white shadow-lg rounded-lg p-3 w-80" style="background: #ffffffcf;border: 1px solid #224ddda3;">
                <img src="<?= base_url() ?>/<?= getenv('prop.applogo') ?>" style="width: 100%;height: 17px;">
                <p><center><strong>Lacak Kendaraan</strong></center></p>
            </div>
            <div class="text-left mb-2 bg-white shadow-lg rounded-lg p-3 w-80" style="background: #ffffffcf;border: 1px solid #224ddda3;">
                <div class="flex items-center space-x-4">
                    <!-- Profile Image -->
                    ...
                    <!-- Information Section -->
                    <div>
                        <p class="font-bold text-gray-800" id="nomor_kendaraan">B 1234 C</p>
                        <p class="font-bold text-gray-800" id="po_name">PO. SIANG MALAM</p>
                    </div>
                </div>
                <div class="border-t border border-gray-400 mt-2 mb-2"></div>
                <div class="flex flex-col space-y-2">
    ...
    <script src="<?= base_url('assets/js/leaflet-rm.js') ?>"></script>
    <script src="//unpkg.com/leaflet-routing-machine@latest/dist/leaflet-routing-machine.js"></script>
    <script src="<?= base_url('assets/js/leaflet-moving-marker.js') ?>"></script>
    <script src="<?= base_url('assets/js/leaflet-rotate.js') ?>"></script>
    ...
    <script src="<?= base_url('assets/js/restAPI.js') ?>"></script>
    <script>
        let baseUrlNgiGps;
        let data_api = null;
        let gps_sn = "";
        ...
        async function initPageLoad() {
            ...
            $.ajax({
                method: 'get',
                url: '<?= base_url('vehicles/polyline') ?>',
                ...
                success:function(response){
                    ...
                    if(ret.status_code==200){
                        ...
                        var additionalBusMarker = L.marker([-7.185863819098109, 112.78003666555523], {
                            icon: L.icon({
                                iconUrl: '<?= base_url('assets/img/bus-md.svg') ?>',
                                iconSize: [25, 41],
                                iconAnchor: [12, 41],
                                popupAnchor: [1, -34],
                                // shadowUrl: 'https://unpkg.com/leaflet/dist/images/marker-shadow.png',
