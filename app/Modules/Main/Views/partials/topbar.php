        ...
        <div class="d-flex">
            <div class="d-none d-md-block navbar-brand-box">
                <a href="<?= base_url() ?>" class="logo logo-dark">
                    <span class="logo-sm" style="overflow: hidden;">
                        <img class="lazy" src="<?= base_url(getenv('prop.applogo')) ?>" alt="" height="15">
                    </span>
                    <span class="logo-lg" style="overflow: hidden;">
                        <img class="lazy" src="<?= base_url(getenv('prop.applogofull')) ?>" alt="" height="20">
            ...
            <div class="app-search d-none d-lg-block">
                <div class="position-relative">
                    <h4 class="page-title mb-0 mt-2 font-size-18 lazy">Dasboard <?= getenv('prop.appname') ?> as <?= $session->get('role_name') ?></h4>
                </div>
            </div>
        </div>
