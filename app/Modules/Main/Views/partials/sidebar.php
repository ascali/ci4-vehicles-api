			...
			<form class="app-search d-none d-lg-block pt-1 pb-1" style="overflow: hidden;">
				<div class="position-relative">
					<div class="input-group">
						...
						<input type="text" class="form-control rounded-pill ps-2 pe-5" id="search" name="search" autocomplete="off" placeholder="<?= lang('Files.Search') ?>" style="background-color: var(--bs-green-200);border: none;">
					</div>
				</div>
			</form>
		</div>
		...
		<div id="sidebar-menu">
			...
			<ul class="metismenu list-unstyled" id="side-menu" style="min-height: 400px">
				...
				<li class="<?= (($module_active == 'main') ? 'active' : '') ?>">
					<!-- <a href="<?= base_url() ?>/main/dashboard_command_center" target="_blank">
